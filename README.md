...
- `workbook/Book2.twbx` — The packaged Tableau workbook containing the interactive data model and visualizations.
- `data/sample_data.csv` — The core dataset and schema driving the ecosystem analysis (anonymized).
- `assets/screenshot-dashboard.png` — High-fidelity preview of the dashboard interface.

## 👁️ How to Interact with the System

1. **Web Access:** Experience the live ecosystem model on [Tableau Public](https://public.tableau.com/app/profile/monowar.hossain6948/viz/Book2_twbtableaureportforsubmission_twbx02/Dashboard1?publish=yes).
2. **Local Exploration:** Download the free *Tableau Reader* or use *Tableau Desktop* to open the `workbook/Book2.twbx` file and explore the data architecture locally.
